...
This is the exact instruction text the production prompt places before the `JOB REQUIREMENTS:` payload. It is reproduced here for audit; the production file `backend/app/services/requirement_matcher.py` is NOT modified.
